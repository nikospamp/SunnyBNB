...
class FavoritesAdapter(var items: List<String>?, var listener: ((houseId: String) -> Unit)?, var context: Context?) : RecyclerView.Adapter<FavoritesAdapter.CustomViewHolder>() {
